  ...
  kaoyan_2026年真题_0: {
    ...
    vocabulary: {
      ...
      arid: {
        ...
        phonetic: "[ˈærɪd]",
        definition: "adj. 干旱的",
        example: "Camels thrive in arid regions.",
      },
    },
    questions: [
      rq(
        ...
        [
          ...
          "They played a critical role in pushing forward human civilizations.",
          "They were vividly portrayed by ancient travelers.",
        ],
        "C",
        "P1 首句 critical for propelling human civilizations forward 直接对应 C。",
      ),
      rq(
        "kaoyan_2026_0_q2",
        "推理题",
        "According to Paragraph 2, donkeys were domesticated ___.",
        [
          "long after horses were tamed",
          "around 3,000 years earlier than horses",
          "in multiple places across the globe",
          "independently in West Europe",
        ],
        "B",
        "P2 明确指出比人类驯化马早约 3000 年。",
      ),
      rq(
        "kaoyan_2026_0_q3",
        "词汇题",
        "The word 'arid' in Paragraph 3 is closest in meaning to ___.",
        ["cold", "dry", "fertile", "coastal"],
        "B",
        "arid 意为干旱的，与 dry 最接近。",
      ),
      rq(
        "kaoyan_2026_0_q4",
        "主旨题",
        ...
        [
          "Donkeys vs. Horses: A Genetic Battle",
          "Unlocking the Genetic Secret of Donkey Domestication",
          "The Cultural Value of Donkeys in East Africa",
          "How DNA Technology Rewrites World Trade History",
        ],
        "B",
        "全文核心为利用基因组揭开驴驯化起源之谜，选 B。",
      ),
    ],
  },
  ...
  kaoyan_2025年真题_0: {
    ...
    vocabulary: {
      ...
      vocational: {
        ...
        definition: "adj. 职业的",
        example: "He took a vocational course in welding.",
      },
    },
    questions: [
      rq(
        ...
        [
          ...
          "the complex trade-offs of pursuing higher education",
          "the rising cost of student debt",
          "policies to reduce tuition fees",
        ],
        "B",
        "全文两段一正一反地权衡高等教育的价值与代价，选 B。",
      ),
      rq(
        "kaoyan_2025_0_q2",
        "细节题",
        "According to Paragraph 2, bachelor's degree holders ___.",
        [
          "earn less due to student debt",
          "still earn more over their lifetimes",
          "cannot repay their loans",
          "prefer vocational jobs",
        ],
        "B",
        "P2 指出即便考虑学生债务，学位持有者一生收入仍显著更高。",
      ),
      rq(
        "kaoyan_2025_0_q3",
        "推理题",
        "What do critics suggest in Paragraph 3?",
        [
          "Formal education is worthless.",
          "Skills-based training deserves more attention.",
          "Student debt should be forgiven.",
          "Universities should raise tuition.",
        ],
        "B",
        "P3 批评者强调技能培训与职业路径被低估。",
      ),
      rq(
        "kaoyan_2025_0_q4",
        "态度题",
        "The author's attitude toward higher education can be described as ___.",
  ...
  kaoyan_2024年真题_0: {
    ...
    vocabulary: {
      ...
      scarcity: {
        ...
        phonetic: "[ˈskeəsəti]",
        definition: "n. 稀缺",
        example: "Scarcity drives up prices.",
      },
    },
    questions: [
      rq(
        "kaoyan_2024_0_q1",
        "推理题",
        "According to the passage, the pleasure of drinking expensive wine mainly stems from ___.",
        [
          "its objectively superior quality",
          "the belief that it is costly",
          "the length of aging",
          "the reputation of the vineyard",
        ],
        "B",
        "P2 指出愉悦感来自 belief that it is expensive。",
      ),
      rq(
        "kaoyan_2024_0_q2",
        "细节题",
        "What have behavioral economists been puzzled by?",
        [
          "Why cheap wines taste bad",
          "Why consumers pay much more for near-identical goods",
          "How brain scans work",
          "Why wines age differently",
        ],
        "B",
        "P1 直接表明经济学家困惑于人们为几乎相同的产品多付钱。",
      ),
      rq(
        "kaoyan_2024_0_q3",
        "细节题",
        "According to Paragraph 3, marketers create narratives of ___.",
        [
          "price and delivery",
          "scarcity, heritage and craftsmanship",
          "youth and speed",
          "science and data",
        ],
        "B",
      ...
      rq(
        "kaoyan_2024_0_q4",
        "主旨题",
        "The best title for the passage would be ___.",
        [
          "How Wine Is Made Today",
          "The Neuroscience Behind Perceived Value",
          "Why Luxury Goods Fail",
          "The Rise of Cheap Wines",
        ],
        "B",
        "文章围绕感知价值的神经科学机制，选 B。",
      ),
  ...
  gaokao_2026年真题_1: {
    ...
    questions: [
      rq(
        "gaokao_2026_1_q1",
        "细节题",
        "What do the student volunteers help do at Yellowstone?",
        [
          "Feed the wild animals daily.",
          "Collect scientific data and educate visitors.",
          "Build new visitor centers.",
          "Guide hiking tours.",
        ],
        "B",
        "P1 明确列出 collect data 和 educate visitors。",
      ),
      rq(
        "gaokao_2026_1_q2",
        "细节题",
        "How did Emma view conservation before this summer?",
        [
          "As full-time scientific research",
          "As just recycling at home",
      ...
      rq(
        "gaokao_2026_1_q3",
        "推理题",
        "What can we infer about Emma from the passage?",
        [
          "She became less interested in nature.",
          "Her understanding of conservation deepened.",
          "She decided to quit the program.",
          "She prefers city life.",
        ],
        "B",
        "从 life-changing 与 Now I understand 可推知其理解加深。",
      ),
      rq(
        "gaokao_2026_1_q4",
        "主旨题",
        ...
        [
          "A Volunteer's Guide to Yellowstone",
          "Teen Volunteers Transform Their View of Conservation",
          "The History of the Wildlife Foundation",
          "Recycling Habits Among High Schoolers",
        ],
        "B",
        "文章聚焦青少年志愿者转变环保观，选 B。",
      ),
  ...
  gaokao_2025年真题_1: {
    ...
    questions: [
      rq(
        "gaokao_2025_1_q1",
        "细节题",
        "What did Marco create through the coding club?",
        [
          "A library management system.",
          "A game for teenagers.",
          "A medication reminder app for the elderly.",
          "A homework helper tool.",
        ],
        "C",
        "P2 明说 tool that helps elderly neighbors schedule medication reminders。",
      ),
      rq(
        "gaokao_2025_1_q2",
        "细节题",
        "Why did Marco go to the library at first?",
        [
          "To join a club",
      ...
      rq(
        "gaokao_2025_1_q3",
        "推理题",
        "Which word best describes Marco's feeling about his achievement?",
        ["Regretful", "Surprised and proud", "Indifferent", "Frustrated"],
        "B",
        "从 I never thought I could 可推 surprised and proud。",
      ),
      rq(
        "gaokao_2025_1_q4",
        "主旨题",
        ...
        [
          "how libraries recruit volunteers",
          "a teenager's unexpected discovery of coding",
    ...
    questions: [
      rq(
        ...
        [
          ...
          "The nutritional value of home-grown vegetables.",
          "City policies on green spaces.",
        ],
        "B",
        "全文围绕邻里连接、幸福感、归属感等社交价值。",
      ),
      rq(
        "gaokao_2024_1_q2",
        "细节题",
        "According to Paragraph 1, community gardens often lead to ___.",
        [
          "business partnerships",
          "potluck dinners and lasting friendships",
      ...
      rq(
        "gaokao_2024_1_q3",
        "细节题",
        "What do studies mentioned in Paragraph 2 show?",
        [
          "Gardeners eat healthier meals only.",
          "Participants feel higher well-being and belonging.",
          "Gardens raise property prices.",
          "Gardens reduce noise pollution.",
        ],
        "B",
        "P2 直接给出。",
      ),
      rq(
        "gaokao_2024_1_q4",
        "推理题",
        "What does the author imply modern city life often lacks?",
  ...
  "kaoyan-er_2026年真题_0": {
    ...
    vocabulary: {
      hybrid: {
        ...
        phonetic: "[ˈhaɪbrɪd]",
        definition: "adj. 混合的",
        example: "Hybrid cars use both fuel and electricity.",
      },
      cohesion: {
        word: "cohesion",
        phonetic: "[kəʊˈhiːʒn]",
      ...
      spontaneous: {
        ...
        definition: "adj. 自发的",
        example: "She gave a spontaneous laugh.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2026_0_q1",
        "细节题",
        "Why are hybrid work arrangements becoming permanent?",
        [
          "Governments have ordered them.",
          "Firms observe higher productivity and lower turnover.",
          "Real-estate costs have dropped.",
          "Employees dislike commuting.",
        ],
        "B",
        "P1 明说 higher productivity and lower turnover。",
      ),
      rq(
        "kaoyan-er_2026_0_q2",
        "细节题",
        "What challenge do managers admit?",
        [
          "Rising IT costs",
      ...
      rq(
        "kaoyan-er_2026_0_q3",
        "词汇题",
        "The word 'deliberately' in Paragraph 2 is closest in meaning to ___.",
        ["carelessly", "intentionally", "briefly", "secretly"],
        "B",
        "deliberately 意为有意地、刻意地。",
      ),
      rq(
        "kaoyan-er_2026_0_q4",
        "推理题",
        "How are some companies redesigning their offices?",
        [
          "Turning them into daily workstations",
          "Turning them into social hubs for collaboration",
          "Selling them entirely",
          "Splitting them into private booths",
        ],
        "B",
        "P3 明说 as social hubs rather than daily workstations。",
      ),
    ],
  },
  "kaoyan-er_2026年真题_1": {
    ...
    vocabulary: {
      ...
      hurdles: {
        ...
        phonetic: "[ˈhɜːdl]",
        definition: "n. 障碍",
        example: "We overcame every hurdle.",
      },
    },
    questions: [
      rq(
        ...
        [
          ...
          "The rise and challenges of urban rooftop farming",
      ...
      rq(
        "kaoyan-er_2026_1_q3",
        "细节题",
        "What structural problem do older buildings face?",
      ...
      rq(
        "kaoyan-er_2026_1_q4",
        "推理题",
        "The author implies municipal regulations ___.",
        [
          "strongly promote innovation",
          "are keeping up with new farming trends",
          "have not kept pace with agricultural innovation",
          "prohibit all rooftop use",
        ],
        "C",
        "lag behind agricultural innovation 直接对应 C。",
      ),
    ],
  },
  "kaoyan-er_2026年真题_2": {
    ...
    vocabulary: {
      commodities: {
        ...
        phonetic: "[kəˈmɒdəti]",
        definition: "n. 商品",
        example: "Oil is a global commodity.",
      },
      consent: {
        word: "consent",
        phonetic: "[kənˈsent]",
        definition: "n. 同意",
        example: "You need written consent.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2026_2_q1",
        "细节题",
        "Why do companies collect consumer data?",
        [
          "To sell it to governments only",
          "To fine-tune advertising and forecast demand",
      ...
      rq(
        "kaoyan-er_2026_2_q2",
        "细节题",
        "What do regulators warn about?",
        [
          "Fast internet speeds",
          "Users' lack of awareness of data use",
      ...
      rq(
        "kaoyan-er_2026_2_q3",
        "细节题",
        "What rights do the new laws give consumers?",
        [
          "The right to free products",
          "The right to demand deletion of records",
          "The right to sue for compensation only",
          "The right to buy company shares",
        ],
        "B",
        "P2 明说 the right to demand deletion。",
      ),
      rq(
        "kaoyan-er_2026_2_q4",
        "主旨题",
        ...
        [
          "A History of Digital Advertising",
          "Consumer Data: Value, Risks and New Rules",
  ...
  "kaoyan-er_2026年真题_3": {
    ...
    vocabulary: {
      renewable: {
        ...
        phonetic: "[rɪˈnjuːəbl]",
        definition: "adj. 可再生的",
        example: "Solar is a renewable resource.",
      },
      retire: {
        word: "retire",
        phonetic: "[rɪˈtaɪə]",
        definition: "v. 使退役，淘汰",
        example: "They retired the old plants.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2026_3_q1",
        "细节题",
        "Why are renewables now competitive with fossil fuels?",
        [
          "Governments have banned coal.",
          "Solar, wind and battery costs have fallen.",
          "Oil supplies have run out.",
      ...
      rq(
        "kaoyan-er_2026_3_q2",
        "细节题",
        "What obstacle do poorer nations face?",
        [
          "Lack of sunlight",
          "Lack of capital for large infrastructure",
          "Overly strict environmental laws",
      ...
      rq(
        "kaoyan-er_2026_3_q3",
        "推理题",
        "What concern do richer economies weigh?",
        [
          "Disruption to employment when retiring coal plants",
          "Rising sea levels only",
          "Trade wars with neighbors",
          "Aging population",
        ],
        "A",
        "P2 后半句直接给出。",
      ...
      rq(
        ...
        "What is the passage mainly about?",
        [
          "The exclusive success of solar power",
          "The uneven progress of the clean-energy transition",
          "How coal will dominate again",
  ...
  "kaoyan-er_2025年真题_0": {
    ...
    vocabulary: {
      autonomy: {
        ...
        phonetic: "[ɔːˈtɒnəmi]",
        definition: "n. 自主权",
        example: "Workers value autonomy.",
      },
      supervision: {
        word: "supervision",
        phonetic: "[ˌsuːpəˈvɪʒn]",
        definition: "n. 监督",
        example: "He worked under supervision.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2025_0_q1",
        "细节题",
        "What benefit does autonomy bring, according to Paragraph 1?",
        [
          "Higher salaries",
      ...
      rq(
        "kaoyan-er_2025_0_q2",
        "推理题",
        "According to Paragraph 2, effective managers ___.",
        [
          "abandon all oversight",
          "set clear goals and give feedback",
          "prohibit remote work",
          "assign detailed daily tasks",
        ],
        "B",
        "P2 明说。",
      ),
      rq(
        "kaoyan-er_2025_0_q3",
        "细节题",
        "What warning do critics raise?",
        [
          "Autonomy raises costs.",
          "Junior staff may feel isolated.",
          "Managers become overworked.",
          "Meetings become endless.",
        ],
        "B",
        "P3 首句给出。",
      ),
      rq(
        ...
        [
          ...
          "the benefits and limits of employee autonomy",
          "the history of management theory",
          "how to design office spaces",
        ],
        "B",
        "全文围绕自主权的益处与限度。",
      ),
  ...
  "kaoyan-er_2025年真题_1": {
    ...
    vocabulary: {
      digitize: {
        ...
        phonetic: "[ˈdɪdʒɪtaɪz]",
        definition: "v. 数字化",
        example: "They digitized the archive.",
      },
      complements: {
        word: "complement",
    ...
    questions: [
      rq(
        "kaoyan-er_2025_1_q1",
        "细节题",
        "What technologies do museums use to open collections online?",
        [
          "Only printed catalogs",
          "High-resolution images, 3-D models and virtual tours",
          "Radio broadcasts",
          "Handwritten letters",
        ],
        "B",
      ...
      rq(
        "kaoyan-er_2025_1_q2",
        "推理题",
        "What do curators believe about digital access?",
        [
          "It will replace visits.",
          "It supplements physical visits.",
          "It is a waste of money.",
          "It should be forbidden.",
        ],
        "B",
        "P2 首句 complements rather than replaces。",
      ),
      rq(
        "kaoyan-er_2025_1_q3",
        "细节题",
        "Why does the passage say physical viewing still matters?",
        [
          "Museums profit from tickets.",
          "It offers scale and material presence.",
          "It is legally required.",
          "Screens cannot show color.",
        ],
        "B",
        "P2 末句给出。",
      ),
      rq(
        ...
        "The best title for the passage is ___.",
        [
          "Why Museums Should Close",
          "Digital and Physical Museums: A Complementary Future",
          "How to Photograph Artifacts",
          "The End of Curatorship",
        ],
        "B",
        "文章强调二者互补。",
      ),
  ...
  "kaoyan-er_2025年真题_2": {
    ...
    vocabulary: {
      adolescents: {
        ...
        phonetic: "[ˌædəˈlesnt]",
        definition: "n. 青少年",
        example: "Adolescents need support.",
      },
      oversimplification: {
        word: "oversimplification",
        phonetic: "[ˌəʊvəˌsɪmplɪfɪˈkeɪʃn]",
        definition: "n. 过度简化",
        example: "This is an oversimplification.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2025_2_q1",
        "细节题",
        "What effect do some researchers link to heavy image-platform use?",
        [
          "Better sleep",
          "Increased anxiety and body-image dissatisfaction",
      ...
      rq(
        "kaoyan-er_2025_2_q2",
        "细节题",
        "What positive role can social media play?",
        [
          "Guaranteeing academic success",
          "Helping isolated youth find supportive communities",
          "Replacing schools entirely",
          "Providing free hardware",
        ],
        "B",
        "P2 明说。",
      ),
      rq(
        "kaoyan-er_2025_2_q3",
        "推理题",
        "What do the second group of scholars argue is the real question?",
        [
          "Whether to ban social media",
          "How to design healthier platforms",
          "Who owns the platforms",
          "Which country regulates them",
        ],
        "B",
        "P2 末句给出。",
      ),
      rq(
        "kaoyan-er_2025_2_q4",
        "主旨题",
        "The passage mainly presents ___.",
        [
          "a one-sided condemnation of social media",
          "a balanced debate on social media and adolescent well-being",
          "a marketing strategy for platforms",
  ...
  "kaoyan-er_2025年真题_3": {
    ...
    vocabulary: {
      infrastructure: {
        ...
        definition: "n. 基础设施",
        example: "Roads are infrastructure.",
      },
      uphill: {
        word: "uphill",
        phonetic: "[ˌʌpˈhɪl]",
        definition: "adj. 艰难的",
        example: "It's an uphill task.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2025_3_q1",
        "细节题",
        "What limits EV adoption according to Paragraph 1?",
        [
          "High vehicle prices only",
          "Range anxiety from sparse charging",
          "Poor vehicle design",
      ...
      rq(
        "kaoyan-er_2025_3_q2",
        "细节题",
        "Where are fast chargers being installed?",
        [
          "Only in airports",
          "Along highways and in residential neighborhoods",
          "Inside factories only",
          "On ships",
        ],
        "B",
        "P2 首句给出。",
      ...
      rq(
        "kaoyan-er_2025_3_q3",
        "细节题",
        "What ongoing challenge does the passage identify?",
        [
          "Producing electricity",
          "Standardizing plugs and payment systems",
          "Training drivers",
          "Manufacturing tires",
        ],
        "B",
      ...
      rq(
        ...
        [
          ...
          "infrastructure as the key to EV adoption",
          "battery chemistry research",
          "the history of gasoline cars",
        ],
        "B",
        "全文围绕基础设施是普及关键。",
      ),
  ...
  "kaoyan-er_2024年真题_0": {
    ...
    vocabulary: {
      fringe: {
        ...
        phonetic: "[frɪndʒ]",
        definition: "adj. 边缘的",
        example: "A fringe benefit.",
      },
      dispersed: {
        word: "dispersed",
        phonetic: "[dɪˈspɜːst]",
        definition: "adj. 分散的",
        example: "A dispersed workforce.",
      },
      impromptu: {
        word: "impromptu",
        phonetic: "[ɪmˈprɒmptjuː]",
        definition: "adj. 即兴的",
        example: "An impromptu meeting.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2024_0_q1",
        "细节题",
        "What do surveys reveal about knowledge workers?",
        [
          "They oppose remote work.",
          "They expect flexibility as a baseline condition.",
          "They demand higher pay only.",
          "They prefer strict oversight.",
        ],
        "B",
        "P1 末句直接给出。",
      ),
      rq(
        "kaoyan-er_2024_0_q2",
        "细节题",
        "What dilemma do employers face?",
        [
          "Choosing between two products",
          "Balancing talent attraction against team coordination challenges",
          "Deciding which country to open in",
          "Whether to hire consultants",
        ],
        "B",
        "P2 明说。",
      ),
      rq(
        "kaoyan-er_2024_0_q3",
        "推理题",
        "How do successful firms treat the office?",
        [
          "As a mandatory daily location",
          "As a purposeful destination for collaboration",
          "As a storage facility",
          "As a place to eliminate entirely",
        ],
        "B",
        "P3 明说。",
      ),
      rq(
        ...
        [
          ...
          "how remote work is reshaping employment expectations and office use",
  ...
  "kaoyan-er_2024年真题_1": {
    ...
    vocabulary: {
      grappling: {
        word: "grapple",
        phonetic: "[ˈɡræpl]",
        definition: "v. 应对，努力解决",
        example: "They grappled with the issue.",
      },
      pension: {
        word: "pension",
        phonetic: "[ˈpenʃn]",
        definition: "n. 养老金",
        example: "He receives a pension.",
      },
      sustain: {
        word: "sustain",
        phonetic: "[səˈsteɪn]",
        definition: "v. 维持",
        example: "Sustain economic growth.",
      },
    },
    questions: [
      rq(
        ...
        [
          "Falling birthrate only",
          "Pressure on pensions and healthcare from aging populations",
          "Rising energy prices",
          "Housing shortages",
        ],
        "B",
        "P1 明说 mounting pressure on pension systems and healthcare budgets。",
      ),
      rq(
        "kaoyan-er_2024_1_q2",
        "细节题",
        "What do some economists propose?",
        [
          "Cutting all pensions",
      ...
      rq(
        "kaoyan-er_2024_1_q3",
        "细节题",
        "What alternative approach is mentioned?",
        [
          "Reducing the workforce",
          "Investing in automation and immigration",
          "Increasing tourism",
      ...
      rq(
        ...
        "The passage mainly presents ___.",
        [
          "different responses to the challenges of aging populations",
  ...
  "kaoyan-er_2024年真题_2": {
    ...
    vocabulary: {
      tuition: {
        ...
        phonetic: "[tjuˈɪʃn]",
        definition: "n. 学费",
        example: "Tuition has risen.",
      },
      substantial: {
        word: "substantial",
        phonetic: "[səbˈstænʃl]",
        definition: "adj. 大量的",
        example: "A substantial loan.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2024_2_q1",
        "细节题",
        "Why is college affordability a top concern?",
        [
          "Universities admit fewer students.",
          "Rising tuition and living expenses.",
          "Fewer scholarships exist.",
          "Employers pay less.",
        ],
        "B",
        "P1 首句直接给出。",
      ...
      rq(
        "kaoyan-er_2024_2_q2",
        "细节题",
        "How do many graduates' loans affect them?",
        [
          "They eliminate travel plans.",
          "They shape early career choices.",
          "They double each year.",
          "They cover living costs only.",
        ],
        "B",
        "P1 末句给出。",
      ),
      rq(
        "kaoyan-er_2024_2_q3",
        "细节题",
        "What have some universities done in response?",
        [
          "Closed campuses",
          "Capped tuition or offered income-based repayment",
          "Raised admission tests",
          "Banned scholarships",
        ],
        "B",
        "P2 明说。",
      ...
      rq(
        "kaoyan-er_2024_2_q4",
        "推理题",
        "Advocates suggest that education is ___.",
        [
          "a private expense only",
          "a public investment",
  ...
  "kaoyan-er_2024年真题_3": {
    ...
    vocabulary: {
      aggregate: {
        ...
        phonetic: "[ˈæɡrɪɡeɪt]",
        definition: "v. 聚集，合计",
        example: "Small actions aggregate.",
      },
      systemic: {
        word: "systemic",
        phonetic: "[sɪˈstemɪk]",
        definition: "adj. 系统性的",
        example: "Systemic reform is needed.",
      },
    },
    questions: [
      rq(
        "kaoyan-er_2024_3_q1",
        "细节题",
        "What consumer behaviors are mentioned as helpful?",
        [
          "Buying imported luxuries",
          "Reducing single-use plastics and choosing seasonal produce",
      ...
      rq(
        ...
        [
          "Consumers do too little.",
          "Placing the entire burden on consumers can distract from systemic issues.",
          "Regulators are irrelevant.",
          "Industries have no role.",
        ],
        "B",
        "P2 首句给出。",
      ),
      rq(
        "kaoyan-er_2024_3_q3",
        "推理题",
        "According to the passage, real environmental change requires ___.",
        [
          "only individual sacrifice",
          "only regulatory action",
          "both personal effort and systemic reform",
          "no reform at all",
        ],
        "C",
        "P2 末句直接给出。",
      ...
      rq(
        ...
        "The best title for the passage is ___.",
        [
          "Consumers Alone Can Save the Planet",
          "Sustainability Needs Both Personal and Systemic Change",
